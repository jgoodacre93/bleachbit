...
!ifdef LANG_FINNISH
	...
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_FINNISH} "Windows Updates:n puhdistaminen edellyttää järjestelmänvalvojan oikeuksia"
	...
	LangString MULTIUSER_PAGE_TITLE ${LANG_FINNISH} "Valitse kansio"
	...
	LangString SECTION_CORE_NAME ${LANG_FINNISH} "Valitse silputtavat tiedostot"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_FINNISH} "Create the shortcut on desktop."
	LangString SECTION_DESKTOP_NAME ${LANG_FINNISH} "Työpöytävimpaimet"
	...
	LangString SECTION_TRANSLATIONS_NAME ${LANG_FINNISH} "Lokalisaatiot"
	LangString SECTION_UNINSTALL_DESCRIPTION ${LANG_FINNISH} "Add uninstall program."
	LangString SECTION_UNINSTALL_NAME ${LANG_FINNISH} "Päivitysten poisto-ohjelmat"
